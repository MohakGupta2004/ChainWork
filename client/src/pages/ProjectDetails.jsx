...
export default function ProjectDetails() {
  ...
  const handlePlaceBid = async (e) => {
    ...
    try {
      const tx = await auth.contract.methods.placeBid(
        id, 
      ...
      console.log(tx);
      alert(`Bid of ${bidAmount} wei placed with comment: "${bidComment}"`);
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-4">
        <label className="block text-gray-800 mb-2" htmlFor="bidAmount">Bid Amount (wei)</label>
        <input
          type="number"
          id="bidAmount"
          value={bidAmount}
